...
type Action = RotateAction Rotation SquareId


type alias Rotation = {clockwise: Bool, pivot:Int, dest:Coord}

type alias Animation = {Rotation | rotation:Int, final:Int}
type alias Square = {pos:Coord, rotation:Maybe Animation}
